...
const notifications = {
  ...
  discord: {
    ...
    notifyGroupSeries: {
      ...
      rx6700: envOrArray(process.env.DISCORD_NOTIFY_GROUP_RX6700),      
      ...
      ryzen3200g: envOrArray(process.env.DISCORD_NOTIFY_GROUP_RYZEN3200G),      
...
const store = {
  ...
  maxPrice: {
    series: {
      ...
      rx6700: envOrNumber(process.env.MAX_PRICE_SERIES_RX6700),      
      ...
      ryzen3200g: envOrNumber(process.env.MAX_PRICE_SERIES_RYZEN3200G),    
      ryzen3400g: envOrNumber(process.env.MAX_PRICE_SERIES_RYZEN3400G),          
